    ...
    <div class="content">
      ...
      <div class="activity-target">
        ...
        <div class="target-content">
          <span>　　为深入贯彻共建共享发展理念，结合“十五五”规划开局阶段工作要求，民生资产现正式启动“团队协同推进计划”。</span><br>
          <span>　　本计划以“协同参与、共建共享”为核心，通过组织带动与用户互动相结合的方式，持续提升参与广度与推进效率，推动相关工作有序开展。</span><br>
          <span>　　活动期间，面向全体用户开放参与通道，鼓励通过邀请参与、协同推进等形式，共同推动整体进程。</span><br>
          <span>　　对于在参与过程中形成有效协同、完成相关流程的，将依据机制给予相应激励支持，进一步增强参与感与获得感，实现发展成果的共享与传导。</span><br>
          <span>　　通过本计划的实施，逐步形成“人人参与、协同推进、成果共享”的良好格局，为后续工作持续推进奠定坚实基础。</span>
        </div>
      </div>
